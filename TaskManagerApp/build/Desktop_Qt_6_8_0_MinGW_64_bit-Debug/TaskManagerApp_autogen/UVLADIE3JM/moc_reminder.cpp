...
constexpr auto qt_meta_stringdata_CLASSReminderENDCLASS = QtMocHelpers::stringData(
    "Reminder",
    "showRemindMessage",
    "",
    "std::vector<QString*>",
...
void Reminder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->showRemindMessage((*reinterpret_cast< std::add_pointer_t<std::vector<QString*>>>(_a[1]))); break;
        case 1: _t->cleanRemindMessage(); break;
        default: ;
        }
    }
}
